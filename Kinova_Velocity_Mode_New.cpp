...
bool torqueControl(k_api::Base::BaseClient* base, k_api::BaseCyclic::BaseCyclicClient* base_cyclic, k_api::ActuatorConfig::ActuatorConfigClient* actuator_config)
{
    ...
    Eigen::Vector<double, 7> qd_prev = Eigen::Vector<double, 7>::Zero();; ///////// ************ ////////////
    ...
    try
    {
        ...
        // Set all actuators to VELOCITY mode
        ...
        //std::cout << "Running Velocity control example for " << TIME_DURATION << " seconds" << std::endl;
